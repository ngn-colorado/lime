 ...
 */
public class LimeFlowEntry implements Comparable<LimeFlowEntry>{
	...
	protected FVFlowMod flowmod;
	/** the newly generated cookie for the FlowMod */
	protected long newcookie;

	public LimeFlowEntry() {
	}
	
	public LimeFlowEntry(FVFlowMod fm, long cookie) {
		this.flowmod = (FVFlowMod) fm.clone();
	...
	public FVFlowMod getFlowMod() {
		return this.flowmod;
	}
	
	public LimeFlowEntry setFlowMod(FVFlowMod fm) {
		this.flowmod = fm;
		return this;
	}
	 ...
	 */
	public LimeFlowEntry setNewCookie(Long cookie) {
		this.newcookie = cookie;
		return this;
	}
	 ...
	 */
	 ...
	 public boolean equals(final Object obj) {
		 ...
		 final LimeFlowEntry other = (LimeFlowEntry) obj;
	  ...
	  * @return
	  */
	 public boolean equals(final FVFlowMod other) {
		 return this.flowmod.equals(other);
	 }

	 @Override
	 public int compareTo(final LimeFlowEntry other) {
	 ...
	 public Map<String, Object> toMap() {
		 ...
		 if (this.flowmod.getMatch() != null) {
			 map.put("match", ((FVMatch)this.flowmod.getMatch()).toMap());
		 }
